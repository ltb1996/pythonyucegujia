...
def main():
    ...
    price_change = ((final_price - predictor.df['Close'].iloc[-1]) / predictor.df['Close'].iloc[-1]) * 100
    print(f'Current Price: {predictor.df["Close"].iloc[-1]:.2f}')
    print(f'Predicted Price (6 months): {final_price:.2f}')
