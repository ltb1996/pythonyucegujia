...
class XiaomiTrendPredictor:
    ...
    def plot_results(self, future_dates, predicted_prices):
        ...
        try:
            ...
            save_path = os.path.join(save_dir, 'xiaomi_trend_prediction_june.png')
            ...
            ax1.set_title('小米集团股票价格（近3个月）', pad=15, fontproperties='SimHei')
            ...
            ax2.set_title('小米集团股票价格（2024年6月预测）', pad=15, fontproperties='SimHei')
...
def main():
    ...
    print('预测图表已保存为 xiaomi_trend_prediction_june.png')
