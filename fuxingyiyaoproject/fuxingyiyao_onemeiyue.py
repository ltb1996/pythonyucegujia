...
class FuxingyiyaoTrendPredictor:
    ...
    def plot_results(self, future_dates, predicted_prices):
        ...
        try:
            ...
            save_path = os.path.join(save_dir, 'fuxingyiyao_trend_prediction_june.png')
            ...
            ax1.plot(recent_data['Date'], recent_data['Close'], label='历史价格', color='blue', linewidth=2)
            ax1.set_title('复星医药股票价格（近3个月）', pad=15, fontproperties='SimHei')
            ...
            ax2.set_title('复星医药股票价格（2024年6月预测）', pad=15, fontproperties='SimHei')
...
def main():
    ...
    print('预测图表已保存为 fuxingyiyao_trend_prediction_june.png')
