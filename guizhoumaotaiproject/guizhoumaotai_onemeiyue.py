...
class MaotaiTrendPredictor:
    ...
    def plot_results(self, future_dates, predicted_prices):
        ...
        try:
            ...
            save_path = os.path.join(save_dir, 'maotai_trend_prediction_june.png')
            ...
            ax1.set_title('贵州茅台股票价格（近3个月）', pad=15, fontproperties='SimHei')
...
def main():
    ...
    print('预测图表已保存为 maotai_trend_prediction_june.png')
