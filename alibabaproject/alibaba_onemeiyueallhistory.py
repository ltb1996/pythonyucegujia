...
class AlibabaTrendPredictor:
    ...
    def plot_results(self, future_dates, predicted_prices):
        ...
        try:
            ...
            save_path = os.path.join(save_dir, 'alibaba_trend_prediction_june_allhistory.png')
            ...
            ax1.set_title('阿里巴巴股票价格（全部历史）', pad=15, fontproperties='SimHei')
            ...
            ax2.set_title('阿里巴巴股票价格（2026年6月预测）', pad=15, fontproperties='SimHei')
...
def main():
    ...
    csv_path = os.path.join(script_dir, '09988.csv')
    predictor = AlibabaTrendPredictor(csv_path)
    predictor.load_data()
    ...
    print('预测图表已保存为 alibaba_trend_prediction_june_allhistory.png')
